...
KNOB_ARC_ANGLE = [   # 弧面出口角偏移(°, 相对 ARC_OUT_ANGLE=35°; 正=向左更陡)。<-25° 会越顶失败, 已 clamp 到 -25
    [(-5.00, 22), (5.07, 26), (1.70, 5), (-3.41, 46)],                        # 0.15
    [(3.87, 24), (12.77, 28), (-19.03, 13), (26.42, 35)],                      # 0.25
    [(-5.08, 8), (19.67, 26), (-15.00, 15), (-10.52, 7), (23.79, 16), (-1.46, 28)],  # 0.35
    [(-12.99, 14), (-0.57, 10), (8.11, 25), (21.52, 15), (18.53, 13), (9.06, 24)],   # 0.45
    [(-15.00, 14), (9.17, 27), (-6.08, 14), (23.69, 25), (7.72, 21)],          # 0.55
    [(-15.00, 13), (-12.89, 21), (23.78, 53), (7.71, 13)],                     # 0.65
    [(-15.00, 14), (-3.11, 21), (8.12, 59), (2.51, 6)],                        # 0.75
    [(29.69, 33), (-5.06, 18), (21.86, 33), (-15.00, 17)],                     # 0.85
    [(-2.08, 12), (11.25, 24), (0.85, 43), (11.54, 21)],                       # 0.95
    [(-15.00, 8), (12.78, 28), (0.36, 23), (29.29, 12), (30.00, 11), (24.69, 17)],  # 1.00
]
KNOB_ARC_BOOST = [   # 弧面出口力度乘子(加速≤30%/减速≤50%)
    [(0.94, 31), (0.71, 9), (0.73, 5), (1.29, 37), (1.11, 18)],              # 0.15
    [(1.30, 22), (1.26, 33), (1.26, 23), (0.97, 8), (1.07, 14)],             # 0.25
    [(1.27, 24), (1.01, 8), (1.12, 13), (0.54, 5), (1.29, 18), (1.29, 32)],  # 0.35
    [(0.64, 21), (1.19, 21), (1.30, 22), (1.10, 5), (1.26, 31)],             # 0.45
    [(1.17, 18), (1.24, 29), (1.11, 6), (0.81, 35), (1.25, 12)],             # 0.55
    [(0.91, 20), (1.27, 20), (1.14, 33), (1.27, 26)],                        # 0.65
    [(1.19, 39), (0.68, 11), (0.62, 9), (0.82, 34), (0.66, 7)],              # 0.75
    [(1.30, 56), (1.20, 36), (1.11, 8)],                                     # 0.85
    [(1.22, 28), (1.11, 6), (1.18, 15), (1.09, 11), (1.20, 40)],             # 0.95
    [(0.70, 10), (1.24, 25), (1.01, 7), (1.18, 20), (1.07, 6), (1.30, 32)],  # 1.00
]
...
KNOB_CEIL_BOOST = [  # 天花板力度: 撞顶后 vx,vy 同乘系数(加速≤30%/减速≤50%)
    [(0.64, 18), (1.15, 13), (0.69, 13), (0.92, 35), (1.07, 6), (1.01, 14)],  # 0.15
    [(1.15, 16), (1.23, 7), (0.51, 16), (0.85, 24), (1.04, 36)],             # 0.25
    [(1.25, 24), (0.70, 13), (0.66, 39), (1.06, 18), (0.94, 6)],             # 0.35
    [(1.01, 18), (1.19, 12), (0.85, 21), (0.94, 37), (0.73, 12)],            # 0.45
    [(1.14, 12), (1.26, 18), (0.79, 30), (0.99, 17), (1.20, 7), (0.83, 16)], # 0.55
    [(1.01, 9), (0.89, 16), (0.96, 21), (1.09, 14), (0.55, 25), (0.80, 14)], # 0.65
    [(0.81, 20), (0.76, 13), (0.55, 20), (0.62, 12), (0.92, 20), (1.16, 15)],# 0.75
    [(1.29, 28), (0.69, 6), (0.73, 36), (1.19, 30)],                         # 0.85
    [(0.61, 10), (0.68, 15), (1.03, 19), (1.22, 34), (0.59, 10), (1.04, 13)],# 0.95
    [(1.02, 13), (1.30, 16), (0.68, 20), (0.82, 13), (1.02, 21), (0.82, 17)],# 1.00
]
