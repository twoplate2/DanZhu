...
2. **物理层**: `Ball`(__slots__ class, 含 `_rng` 撞钉扰动流), `physics_step`, `launch_ball`, `advance_flight`(纯被动: 重力+碰撞, 零干预), `benchmark_trajectories`
   ...
   - **盘面固定格数**: `roll_multipliers` 按 `KNOB_K` 表掷"本局几个格子有奖"(80%档 2格85.1%/3格14.9%、120%档 3格/4格、200%档 5格/6格、360%档 5格/6格/7格), 再 random.sample 选位置填 `_reward_value`(x2 55%/x3 25%/x5 13%/x10 5.5%/x20 1.5%, EV=3.35)。RTP 精确=档位, 消灭"只有1格有奖"烂盘, x10/x20 完整保留
